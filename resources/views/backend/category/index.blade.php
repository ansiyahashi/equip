        ...
        <div class="col-md-12 mb-4">
            <div class="card text-left">
                ...
                <div class="card-header text-right bg-transparent">
                    <button type="button" data-toggle="modal" data-target=".category_modal" class="btn btn-primary btn-md m-1"><i
                            class="i-Add-User text-white mr-2"></i> {{ __('Add Category') }}</button>
                </div>
                <div class="card-body">
